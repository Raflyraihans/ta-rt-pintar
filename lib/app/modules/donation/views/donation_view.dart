...
import 'package:rtkita/app/modules/donation/views/detail_donation_view.dart';
              ...
              child: GetBuilder<DonationController>(
                  ...
                  builder: (c) {
                    return ListView.builder(
                        itemCount: c.donation.length,
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              Get.to(() => DetailView(c.donation[index]));
                            },
                            child: Container(
                                      ...
                                      Container(
                                        ...
                                        child: ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                                ...
                                                // "https://rt-pintar.imagi.id/${c.donation[index].picture!}",
                                                height: 160,
